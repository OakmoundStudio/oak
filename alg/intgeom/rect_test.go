...
func TestRectConstructors(t *testing.T) {
	...
	if (Rect3{Min: Point3{0, 0, 0}, Max: Point3{1, 1, 1}}) != NewBoundingRect3(Point3{0, 0, 0}, Point3{0, 1, 1}, Point3{1, 1, 0}, Point3{1, 0, 1}) {
		t.Fatalf("expected %v, got %v", Rect3{Min: Point3{0, 0, 0}, Max: Point3{1, 1, 1}}, NewBoundingRect3(Point3{0, 0, 0}, Point3{0, 1, 1}, Point3{1, 1, 0}, Point3{1, 0, 1}))
	}
}
